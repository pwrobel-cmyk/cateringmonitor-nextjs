...
const financialData = [
  { year: "2018", revenue: 3981.0, netProfit: 137.7, ebitda: 151.5, assets: 0 },
  { year: "2019", revenue: 0, netProfit: 0, ebitda: 0, assets: 988.0 },
  { year: "2020", revenue: 5815.7, netProfit: 22.3, ebitda: 24.7, assets: 895.9 },
  { year: "2021", revenue: 11572.0, netProfit: 154.3, ebitda: 194.1, assets: 1501.7 },
  { year: "2022", revenue: 62843.1, netProfit: 203.8, ebitda: 597.7, assets: 10658.3 },
  { year: "2023", revenue: 105934.4, netProfit: 5786.4, ebitda: 7152.3, assets: 17609.0 },
];

const balanceData2023 = {
  assets: [
    { name: "Aktywa trwałe", value: 9619.964, color: "hsl(var(--primary))" },
    { name: "Aktywa obrotowe", value: 7989.046, color: "hsl(var(--chart-2))" },
  ],
  liabilities: [
    { name: "Kapitał własny", value: 7224.581, color: "hsl(var(--success))" },
    { name: "Zobowiązania długoterminowe", value: 3456.234, color: "hsl(var(--chart-3))" },
    { name: "Zobowiązania krótkoterminowe", value: 6928.195, color: "hsl(var(--chart-4))" },
  ],
};

const valuationData = [
  { year: "2018", valuation: 3204.7 },
  { year: "2019", valuation: 140.7 },
  { year: "2020", valuation: 4124.0 },
  { year: "2021", valuation: 8605.0 },
  { year: "2022", valuation: 43136.4 },
  { year: "2023", valuation: 98500.0 },
];

const profitabilityMetrics = [
  { year: "2018", roa: 0, roe: 0, operatingMargin: 3.8, netMargin: 3.5 },
  { year: "2019", roa: 0, roe: 0, operatingMargin: 0, netMargin: 0 },
  { year: "2020", roa: 2.5, roe: 4.8, operatingMargin: 0.4, netMargin: 0.4 },
  { year: "2021", roa: 10.3, roe: 15.7, operatingMargin: 1.7, netMargin: 1.3 },
  { year: "2022", roa: 1.9, roe: 3.2, operatingMargin: 1.0, netMargin: 0.3 },
  { year: "2023", roa: 32.9, roe: 80.1, operatingMargin: 6.8, netMargin: 5.5 },
];

const companyInfo = {
  name: "GASTRO MAGAZYN SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ",
  krs: "0000773155",
  nip: "5882446975",
  regon: "382646000",
  address: "ul. Usługowa 1, 84-240 Reda",
  voivodeship: "Pomorskie",
  website: "dietytreningowe.pl",
  email: "kontakt@dietytreningowe.pl",
  foundedYear: "2018",
  businessType: "Catering dietetyczny dla sportowców",
  description: "Firma specjalizuje się w dostawie diet pudełkowych dla sportowców i osób aktywnych fizycznie. Oferuje ponad 4000 lokalizacji w Polsce, szeroki wybór diet (keto, wegetariańskie, bezglutenowe) oraz elastyczne plany dietetyczne z możliwością zamawiania online.",
  insolvencyRisk: 0.02,
  capitalStock: 55150,
};

export default function GastroMagazyn() {
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-6">
              <div className="h-20 w-20 rounded-lg bg-white p-2 flex items-center justify-center shadow-sm">
                <img 
                  src="https://jpwabrhowkjmuaxnnfhk.supabase.co/storage/v1/object/public/brand-logos/logos/1759140677042-8oep0f.jpg" 
                  alt="Gastropaczka logo" 
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">98.5 mln zł</div>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Przychody i Zyski (2018-2023)</CardTitle>
          ...
          <TabsContent value="profitability" className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-success">{profitabilityMetrics[5].roa}%</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-success">{profitabilityMetrics[5].roe}%</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{profitabilityMetrics[5].operatingMargin}%</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{profitabilityMetrics[5].netMargin}%</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Wskaźniki zwrotu w latach 2018-2023</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer
                  config={{
          ...
          <TabsContent value="balance" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Podział aktywów na koniec 2023</CardDescription>
                </CardHeader>
                <CardContent>
                  <ChartContainer
                    config={{
                  ...
                  <div className="mt-4 space-y-2">
                    {balanceData2023.assets.map((item) => (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Źródła finansowania na koniec 2023</CardDescription>
                </CardHeader>
                <CardContent>
                  <ChartContainer
                    config={{
                  ...
                  <div className="mt-4 space-y-2">
                    {balanceData2023.liabilities.map((item) => (
                      <div key={item.name} className="flex items-center justify-between text-sm">
                        <span className="flex items-center gap-2">
                          <div className="h-3 w-3 rounded-full" style={{ backgroundColor: item.color }} />
                          {item.name}
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">59.0%</div>
                  <p className="text-xs text-muted-foreground mt-2">Średni poziom zadłużenia</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Stan na koniec 2023</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-3xl font-bold text-success">7,225 k zł</div>
                  <p className="text-xs text-muted-foreground mt-2">41.0% pasywów</p>
                </CardContent>
              </Card>

              <Card>
                <CardHeader>
                  <CardTitle>Kapitał zakładowy</CardTitle>
                  <CardDescription>Kapitał podstawowy</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-3xl font-bold">{companyInfo.capitalStock.toLocaleString('pl-PL')} zł</div>
                  <p className="text-xs text-muted-foreground mt-2">Kapitał rejestrowy</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Wzrost aktywów w latach 2018-2023</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer
                  config={{
          ...
          <TabsContent value="valuation" className="space-y-6">
            <div className="grid gap-4 md:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">4.7 mln zł</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-primary">98.5 mln zł</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">264.8 mln zł</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Wzrost wartości firmy w latach 2018-2023</CardDescription>
              </CardHeader>
              <CardContent>
                <ChartContainer
                  config={{
                ...
                <div className="pt-4 border-t">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="font-semibold ml-2">13.8x</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Mnożnik P/E:</span>
                      <span className="font-semibold ml-2">17.0x</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">WACC:</span>
                      <span className="font-semibold ml-2">9.2%</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Wzrost progn.:</span>
                      <span className="font-semibold ml-2">25% p.a.</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Liczba lokalizacji</span>
                    <span className="font-semibold">4,000+</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Kapitał zakładowy</span>
                    <span className="font-semibold">{companyInfo.capitalStock.toLocaleString('pl-PL')} zł</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Satysfakcja klientów</span>
                    <span className="font-semibold flex items-center">
                      4.8/5 <Star className="h-4 w-4 ml-1 fill-yellow-500 text-yellow-500" />
                    </span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-3 space-y-2 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <span>Dynamiczny wzrost przychodów (CAGR 159%)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-success mt-1.5" />
                      <span>Bardzo wysoka rentowność (ROE 80%)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-success mt-1.5" />
                      <span>Szeroka sieć dystrybucji (4000+ lokalizacji)</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-yellow-500 mt-1.5" />
                      <span>Wysoka konkurencja w segmencie sportowym</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
